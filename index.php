                ...
                <div class="row align-items-center">
                    <div class="col-xl-5 col-lg-6">
                        <div class="header-content-right">
                            ...
                            <h1 class="title">Fatima Zahra Tijani</h1>
                            <p> </p>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="header-social-icon">
                                <ul>
                                    <li><a href="https://fr-fr.facebook.com/"><i class="lni-facebook-filled"></i></a></li>
                                    
                                   
                                    <li><a href="https://www.linkedin.com/feed/"><i class="lni-linkedin-original"></i></a></li>
                                </ul>
                            </div> <!-- header social -->
                        </div>
                    </div> <!-- row -->
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="about-content mt-50">
                        <h5 class="about-title">Hi There! I'm fatima zahra Tijani</h5>
                        <p> A full stack integratrice web & mobile app developer based in youssoufia, Morocco . My skills are broad, from ux to design, front-end to back-end development. I enjoy each aspect, and love building web apps & mobile apps from start to finish. Learning for me equates to exploring new ideas and growing as an individual.</p>
                        <ul class="clearfix">
                            <li>
                                <div class="single-info d-flex align-items-center">
                                    ...
                                    <div class="info-text">
                                        <p><span>Date of birth:</span> 6 octobre 1999</p>
                                    </div>
                                </div> <!-- single info -->
                            </li>
                            <li>
                                <div class="single-info d-flex align-items-center">
                                    ...
                                    <div class="info-text">
                                        <p><span>Email:</span>fatitijani001@gmail.com</p>
                                    </div>
                                </div> <!-- single info -->
                            </li>
                            <li>
                                <div class="single-info d-flex align-items-center">
                                    ...
                                    <div class="info-text">
                                        <p><span>Phone:</span> 212 677627654</p>
                                    </div>
                                </div> <!-- single info -->
                            </li>
                            <li>
                ...
                <div class="col-xl-5 offset-xl-1 col-lg-6">
                    <div class="about-skills pt-25">
                        ...
                        <div class="skill-item mt-25">
                            <div class="skill-header">
                                <h6 class="skill-title">Adob XD</h6>
                                <div class="skill-percentage">
                                    <div class="count-box counted">
                                        <span class="counter">50</span>
                                    </div>
            ...
            <div class="row">
                    ...
                    <div class="single-work text-center mt-30">
                        ...
                        <div class="work-overlay">
                            ...
                            <div class="work-content">
                                ...
                                <h3 class="work-title">Horlog</h3>
                                <ul>
                                   <img src="horlog.jpg">
                                    <li><a href="https://fati9999.github.io/horloge-f"><i class="lni-link"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div> <!-- single work -->
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="single-work text-center mt-30">
                        ...
                        <div class="work-overlay">
                            <div class="work-content">
                                <h3 class="work-title">covid-19</h3>
                                <ul>
                                   <img src="covid.png">
                                   
                                    <li><a href=" https://fati9999.github.io/Covid-19"><i class="lni-link"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div> <!-- single work -->
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="single-work text-center mt-30">
                        ...
                        <div class="work-overlay">
                            <div class="work-content">
                                <h3 class="work-title">gestion de conge</h3>
                                <ul>
                                    <img src="gestion.jpg">
                                   
                                    <li><a href="https://fati9999.github.io/gestion_conge"><i class="lni-link"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div> <!-- single work -->
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="single-work text-center mt-30">
                        ...
                        <div class="work-overlay">
                            <div class="work-content">
                                <h3 class="work-title">site E-commerce</h3>
                                <ul>
                                    <img src="commerce.png">
                                    
                                    <li><a href= "https://fati9999.github.io/Site-E-Commerce"><i class="lni-link"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div> <!-- single work -->
